...
public class AIService {
    ...
    public static class Prompts {
        ...
        public static final String SUMMARY_PREFIX = "Give a concise, high level overview of the following chat logs. No need for complete sentences. Make use of bullet points of key topics with timestamp; include zero or more chat messages verbatim (with username) as sub-bullets. Bias including discovered solutions or technical resources. Do not exceed 30 seconds of reading time.\n\n";
