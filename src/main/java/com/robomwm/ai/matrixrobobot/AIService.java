...
public class AIService {
    ...
    public static class Prompts {
        ...
        public static final String SUMMARY_PREFIX = "Give a high level overview of the following chat logs. Use only a title and timestamp for each topic and only include one chat message verbatim (with username) for each topic; bias to include discovered solutions, unanswered questions, or useful resources. Don't use table format. Then collect a list of all chat messages verbatim (with username) that contain discovered solutions or useful resources:\n\n";
