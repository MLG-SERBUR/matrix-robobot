...
public class AIService {
    ...
    public static void applyArliAiNonThinkingDefaults(Map<String, Object> payload) {
        payload.putIfAbsent("temperature", 0.3);
        payload.putIfAbsent("top_p", 0.9);
    ...
    public static class Prompts {
        ...
        public static final String SUMMARY_PREFIX = "Give a concise, high level overview (no analysis) of the following chat logs. No complete sentences. Make use of bullet points of key topics with timestamp; include zero or more chat messages verbatim (with username) as sub-bullets. Bias including discovered technical facts or solutions or resources, philosophical discussions, and projects. Do not exceed 30 seconds of reading time.\n\n";
        public static final String TLDR_PREFIX = "Provide a very concise summary of the following chat logs that can be read in 15 seconds or less. Make use of bullet points of key topics with timestamp; be extremely brief, no complete sentences but preserve subject-verb. Prefer philosophical or technical topics or projects that are informative towards a discovered fact or solution or resources. Then directly include the best chat message verbatim with author; have bias towards one that is informative towards a discovered solution or informative resource, and must not be an ai paste:\n\n";
