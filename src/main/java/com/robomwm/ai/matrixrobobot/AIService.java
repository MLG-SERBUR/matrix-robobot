...
public class AIService {
    ...
    public static class Prompts {
        ...
        public static final String SUMMARY_PREFIX = "Give a concise, high level overview of the following chat logs. No need for complete sentences. Use only a title and timestamp for each topic; include one chat message verbatim (or more, only if necessary) with username for each topic. No table format:\n\n";
        public static final String CAVEMAN_PREFIX = "Give a high level overview of the following chat logs. Use only a title and timestamp for each topic using caveman style. Optionally include one or more chat messages verbatim (with username) as bullet points for each topic; bias to include discovered solutions, unanswered questions, or interesting resources. Don't use table format. Then summarize with bullet points all of the chat at end in caveman style. This is caveman style: Caveman style is: Terse like caveman. Technical substance exact. Only fluff die. Drop: articles, filler (just/really/basically), pleasantries, hedging. Fragments OK. Short synonyms.\n\n"; //TODO REMOVE
