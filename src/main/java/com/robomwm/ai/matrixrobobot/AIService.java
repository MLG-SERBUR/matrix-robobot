...
public class AIService {
    ...
    public static class Prompts {
        ...
        public static final String CAVEMAN_PREFIX = "Give a high level overview of the following chat logs. Use only a title and timestamp for each topic and only include one or more chat messages verbatim (with username) as bullet points for each topic; bias to include discovered solutions, unanswered questions, or interesting resources. Don't use table format. Then summarize with bullet points all of the chat at end, including discovered solutions or interesting resources; no complete sentences required, this should be brief and avoid analysis. Cover the same topic breadth as a long summary. Write in caveman style: terse fragments, no articles, no filler, no pleasantries, no hedging. Short synonyms. Technical substance exact:\n\n";
